...
ALTER TABLE [MANTECA].[BI_Sector]
ADD CONSTRAINT FK_CIRCUITO FOREIGN KEY(ID_CIRCUITO) REFERENCES [MANTECA].Circuito(ID_CIRCUITO);
...
ALTER TABLE [MANTECA].[BI_Medicion_Auto]
ADD CONSTRAINT FK_AUTO FOREIGN KEY(ID_AUTO) REFERENCES [MANTECA].Auto(ID_AUTO),
CONSTRAINT FK_PILOTO FOREIGN KEY(ID_PILOTO) REFERENCES [MANTECA].Piloto(ID_PILOTO);
...
ALTER TABLE [MANTECA].[BI_Medicion_Motor]
ADD CONSTRAINT FK_MOTOR FOREIGN KEY(ID_MOTOR) REFERENCES [MANTECA].Motor(ID_MOTOR),
CONSTRAINT FK_MEDICION_AUTO FOREIGN KEY(MEDICION_AUTO) REFERENCES [MANTECA].Medicion_Auto(ID_MEDICION);
...
ALTER TABLE [MANTECA].[BI_Medicion_Neumatico]
...
ALTER TABLE [MANTECA].[BI_Medicion_Frenos]
...
ALTER TABLE [MANTECA].[BI_Medicion_Caja_De_Cambios]
...
ALTER TABLE [MANTECA].[BI_Auto_Incidentado]
ADD CONSTRAINT FK_INCIDENTE FOREIGN KEY(ID_INCIDENTE) REFERENCES [MANTECA].Incidente(ID_INCIDENTE), 
CONSTRAINT FK_AUTO FOREIGN KEY(ID_AUTO) REFERENCES [MANTECA].Auto(ID_AUTO);
