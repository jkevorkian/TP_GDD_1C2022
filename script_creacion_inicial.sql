...
(NUMERO_VUELTA, PARADA_DURACION, A.ID_AUTO)
SELECT PARADA_BOX_VUELTA, PARADA_BOX_TIEMPO, A.ID_AUTO FROM gd_esquema.Maestra
...
GROUP BY PARADA_BOX_TIEMPO,PARADA_BOX_VUELTA, A.ID_AUTO--OK
...
SELECT TELE_AUTO_NUMERO_VUELTA, TELE_AUTO_DISTANCIA_VUELTA, TELE_AUTO_POSICION, TELE_AUTO_TIEMPO_VUELTA,
        TELE_AUTO_VELOCIDAD, TELE_AUTO_COMBUSTIBLE , p.ID_PILOTO, a.ID_AUTO, TELE_AUTO_CODIGO FROM gd_esquema.Maestra
...
GROUP BY TELE_AUTO_NUMERO_VUELTA , p.ID_PILOTO , a.ID_AUTO, TELE_AUTO_DISTANCIA_VUELTA , TELE_AUTO_POSICION , TELE_AUTO_TIEMPO_VUELTA , TELE_AUTO_VELOCIDAD , TELE_AUTO_COMBUSTIBLE, TELE_AUTO_CODIGO--OK?
...
(CAJA,RPM, TEMPERATURA_ACEITE, DESGASTE_PORCENTUAL_ACUMULADO, ID_CAJA_CAMBIO)
SELECT TELE_CAJA_MODELO, TELE_CAJA_RPM, TELE_CAJA_TEMP_ACEITE, TELE_CAJA_DESGASTE, C.ID_CAJA_CAMBIO FROM gd_esquema.Maestra
...
GROUP BY TELE_CAJA_MODELO, TELE_CAJA_RPM, TELE_CAJA_TEMP_ACEITE, TELE_CAJA_DESGASTE, C.ID_CAJA_CAMBIO--OK?	
...
(POTENCIA_MOMENTANEA, RPM, TEMP_ACEITE, TEMP_AGUA, ID_MOTOR)
SELECT TELE_MOTOR_POTENCIA, TELE_MOTOR_RPM, TELE_MOTOR_TEMP_ACEITE, TELE_MOTOR_TEMP_AGUA, M.ID_MOTOR FROM gd_esquema.Maestra
...
GROUP BY TELE_MOTOR_POTENCIA, TELE_MOTOR_RPM, TELE_MOTOR_TEMP_ACEITE, TELE_MOTOR_TEMP_AGUA, M.ID_MOTOR--OK?
...
(GROSOR_PASTILLA, POSICION, TEMPERATURA, ID_FRENO)
SELECT DISTINCT TELE_FRENO1_GROSOR_PASTILLA, TELE_FRENO1_POSICION, TELE_FRENO1_TEMPERATURA,F.ID_FRENO FROM gd_esquema.Maestra
...
UNION
SELECT TELE_FRENO2_GROSOR_PASTILLA, TELE_FRENO2_POSICION, TELE_FRENO2_TEMPERATURA, F.ID_FRENO FROM gd_esquema.Maestra
...
UNION
SELECT TELE_FRENO3_GROSOR_PASTILLA,TELE_FRENO3_POSICION, TELE_FRENO3_TEMPERATURA, F.ID_FRENO FROM gd_esquema.Maestra
...
UNION
SELECT TELE_FRENO4_GROSOR_PASTILLA, TELE_FRENO4_POSICION, TELE_FRENO4_TEMPERATURA, F.ID_FRENO FROM gd_esquema.Maestra
...
(POSICION, PRESION, PROFUNDIDAD, TEMPERATURA, ID_NEUMATICO)
SELECT TELE_NEUMATICO1_POSICION, TELE_NEUMATICO1_PRESION, TELE_NEUMATICO1_PROFUNDIDAD, TELE_NEUMATICO1_TEMPERATURA , n.ID_NEUMATICO FROM gd_esquema.Maestra
JOIN [MANTECA].Neumatico n ON n.NRO_SERIE = gd_esquema.Maestra.TELE_NEUMATICO1_NRO_SERIE
UNION
SELECT TELE_NEUMATICO2_POSICION, TELE_NEUMATICO2_PRESION, TELE_NEUMATICO2_PROFUNDIDAD, TELE_NEUMATICO2_TEMPERATURA , n.ID_NEUMATICO FROM gd_esquema.Maestra
JOIN [MANTECA].Neumatico n ON n.NRO_SERIE = gd_esquema.Maestra.TELE_NEUMATICO2_NRO_SERIE
UNION
SELECT TELE_NEUMATICO3_POSICION, TELE_NEUMATICO3_PRESION, TELE_NEUMATICO3_PROFUNDIDAD, TELE_NEUMATICO3_TEMPERATURA , n.ID_NEUMATICO FROM gd_esquema.Maestra
JOIN [MANTECA].Neumatico n ON n.NRO_SERIE = gd_esquema.Maestra.TELE_NEUMATICO3_NRO_SERIE
UNION
SELECT TELE_NEUMATICO4_POSICION, TELE_NEUMATICO4_PRESION, TELE_NEUMATICO4_PROFUNDIDAD, TELE_NEUMATICO4_TEMPERATURA , n.ID_NEUMATICO FROM gd_esquema.Maestra
...
(ID_CARRERA, ID_SECTOR, DISTANCIA_RECORRIDA_CARRERA, ID_AUTO)
SELECT C.ID_CARRERA, S.ID_SECTOR, TELE_AUTO_DISTANCIA_CARRERA, A.ID_AUTO FROM gd_esquema.Maestra
...
GROUP BY C.ID_CARRERA, S.ID_SECTOR, TELE_AUTO_DISTANCIA_CARRERA, A.ID_AUTO--ok?